...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libunibreak",
            url: "https://github.com/Tinuv-Dev/FFMPEGBuilder/releases/download/v1.1/libunibreak.zip",
            checksum: "296f34f6b34343ca88fbd327ac5c9e7f542c6f12dbf74f939ab6287301b5caa2"
        ),
        .binaryTarget(
            name: "libzvbi",
